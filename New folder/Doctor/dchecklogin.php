...
//$mylicense = stripslashes($mylicense);
//$mystaffID = mysql_real_escape_string($mystaffID);
//$mylicense = mysql_real_escape_string($mylicense);
//$mycarecardint = (int) $mystaffID;
//$sql="SELECT * FROM patient WHERE staffID=$mystaffID AND name='$mylicense'";
...
header("location:dloginsuccess.php");
